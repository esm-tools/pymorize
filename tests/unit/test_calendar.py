...
def test_simple_ranges_from_bounds():
    bounds = [(1, 5), (10, 15)]
    result = list(pymorize.core.calendar.simple_ranges_from_bounds(bounds))
...
def test_single_range():
    bounds = [(1, 5)]
    result = pymorize.core.calendar.simple_ranges_from_bounds(bounds)
    expected = range(1, 6)
    assert result == expected
...
def test_date_ranges_from_bounds():
    ...
    result = pymorize.core.calendar.date_ranges_from_bounds(bounds)
    expected = (
...
def test_year_bounds_major_digits_first_can_end_with_binning_digit():
    bounds = pymorize.core.calendar.year_bounds_major_digits(
